...
namespace GetInfoFromExchange.UISearchTextBox
{
    class ListBoxEx : ListBox
    {
        ...
        public ItemStyles ExtendedStyle
        {
            ...
            set
            {
                ...
                resDict.Source = new Uri("pack://application:,,,/GetInfoFromExchange;component/UISearchTextBox/Themes/ListBoxEx.xaml");
