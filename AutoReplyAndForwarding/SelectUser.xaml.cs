using AutoReplyAndForwarding.DataProvider;
using AutoReplyAndForwarding.Model;
using AutoReplyAndForwarding.UISearchTextBox;
using System;
...
namespace AutoReplyAndForwarding
{
    ...
    public partial class SelectUser : Window
    {
        ...
        {
            SelectedUser = (User)ListUsersForSelected.SelectedItem;
            DialogResult = true;
            Close();
        }
