...
namespace RussificationOutlookFolders.UISearchTextBox
{
    class ListBoxEx : ListBox
    {
        ...
        public ItemStyles ExtendedStyle
        {
            ...
            set
            {
                ...
                resDict.Source = new Uri("pack://application:,,,/RussificationOutlookFolders;component/UISearchTextBox/Themes/ListBoxEx.xaml");
