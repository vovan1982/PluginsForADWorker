using ChangeSurname.DataProvider;
using ChangeSurname.Model;
using ChangeSurname.UISearchTextBox;
using System;
...
namespace ChangeSurname
{
    ...
    public partial class SelectUser : Window
    {
        ...
        {
            SelectedUser = ((User)ListUsersForSelected.SelectedItem).PlaceInAD;
            DialogResult = true;
            Close();
        }
